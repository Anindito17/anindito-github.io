...
<nav class="navbar navbar-expand-md navbar-light bg-light main-menu" style="box-shadow:none">
  <div class="container">
    ...
    <img class="pic-1" src="/img/glovo.webp" height="50px" width="100px">
    </a>
    ...
    <div class="collapse navbar-collapse">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item ml-md-3">
          <a class="btn btn-primary" href="#"><i class="bx bxs-user-circle"></i> </a>
        </li>
      </ul>
    </div>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid4">
                <div class="product-image4">
                    <a href="#">
                        <img class="pic-1" src="/img/q1.jpg">
                        <img class="pic-2" src="/img/q2.jpg">
                    </a>
                    <span class="product-new-label">New</span>
                    <span class="product-discount-label">-10%</span>
                </div>
                <div class="product-content">
                    <h3 class="title"><a href="#">Qtela Tempe Cabai Rawit 55g</a></h3>
                    <div class="price">
                    Rp 7.700
                        <span>Rp 8.000</span>
                    </div>
...
<div class="container-fluid">© GlovoryMart - All rights reserved.
</div>

</body>
</html><?php /**PATH E:\Laragon\www\glovory\resources\views/index/shop.blade.php ENDPATH**/ ?>